  ...
  <article class="case" id="case-${index}">
    ...
    <div class="case-body">
      ...
      <div class="section">
        ...
        <p class="preview-note">Curl khớp header production + request-id. Copy vào Postman Import → Raw text. Host/Connection do HTTP client gắn, không in trong curl. Authorization / Cookie / password hiện nguyên để replay.</p>
...
function renderMdCase(index, c) {
  ...
  if (curl) {
    lines.push('cURL (copy vào Postman — token/cookie/password hiện nguyên):');
    lines.push('');
